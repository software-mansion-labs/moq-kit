...
// MoqError is the public moq-swift alias for the underlying UniFFI error.
...
extension MoqError {
    var moqKitMessage: String {
        ...
        case .Protocol(message: let value),
             ...
             .NotFound(message: let value),
             .Unsupported(message: let value),
             .InvalidRoute(message: let value),
